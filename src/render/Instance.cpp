...
magmatic::render::Instance::Instance(
...
std::vector<magmatic::render::PhysicalDevice> magmatic::render::Instance::enumeratePhysicalDevices() const
{
...
magmatic::render::PhysicalDevice magmatic::render::Instance::getBestDevice() const {
...
magmatic::render::Surface magmatic::render::Instance::createSurface(const magmatic::render::Window& window) const
{
